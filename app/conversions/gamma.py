...
def convert(audio: AudioSegment) -> AudioSegment:
    print("Processing Gamma (30–100 Hz) conversion...")

    # Define parameters
    target_frequency = 40  # Target binaural beat frequency in Hz (within the gamma range)
    base_frequency = 200  # Base tone frequency in Hz
